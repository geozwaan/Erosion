...
sys.path.insert(1,'/home/bbkcygne/ParaView-5.9.1-MPI-Linux-Python3.8-64bit/lib/python3.8/site-packages/')
from paraview.simple import *


#Input path to your paraview directory
#sys.path.insert(1,'/home/djneuh/software/aParaView-5.9.1/lib/python3.8/site-packages/')

# The index of visualization output in statistics file
#vindex = 30
