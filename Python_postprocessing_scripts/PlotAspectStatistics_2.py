...
### INPUT ###
# folder name (glob allows wildcarts in names)
#foldernamelist = glob.glob('/home/brune/_prog/aspect/09_VictoriaBlock/02b2*/output/')
#foldernamelist = glob.glob('/home/brune/_prog/aspect/11_2DMenderes/04*/output/') # unfortunately no {brace expansion} inside glob
#foldernamelist = glob.glob('/home/brune/_prog/aspect/07_ObliqueRift/26*/output/') # unfortunately no {brace expansion} inside glob
#foldernamelist = glob.glob('/home/brune/_prog/aspect/14_Andaman/11*/output/') # unfortunately no {brace expansion} inside glob
#foldernamelist = glob.glob('/home/brune/_prog/aspect/13_2D_Tests/23*/output/')
#foldernamelist = glob.glob('/home/brune/_prog/aspect/11_2DMenderes/08*/output/')
foldernamelist = glob.glob('./')
#foldernamelist = glob.glob('/Users/brune/_prog/aspect/20_Rift2Ridge_3D/52g*/output/')
#foldernamelist = glob.glob('/Users/brune/_prog/aspect/23_PopUpErosion/17d*/output/')
#foldernamelist = glob.glob('/Users/brune/_prog/aspect/25_MultiExtension/22*/output/')
